    ...
    <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        <div className="flex flex-col rounded-xl p-4 md:p-6 bg-white border border-gray-200 dark:bg-slate-900 dark:border-gray-700">
          ...
          <p className="mt-3 text-gray-500">CSI - IT</p>
        ...
        <div className="flex flex-col rounded-xl p-4 md:p-6 bg-white border border-gray-200 dark:bg-slate-900 dark:border-gray-700">
          <div className="flex items-center gap-x-4">
            ...
            <div className="grow">
              ...
              <p className="text-xs uppercase text-gray-500">2024-25</p>
            </div>
          </div>
        ...
        <div className="flex flex-col rounded-xl p-4 md:p-6 bg-white border border-gray-200 dark:bg-slate-900 dark:border-gray-700">
          ...
          <p className="mt-3 text-gray-500">CSI FCRIT</p>
        ...
        <div className="flex flex-col rounded-xl p-4 md:p-6 bg-white border border-gray-200 dark:bg-slate-900 dark:border-gray-700">
          <div className="flex items-center gap-x-4">
            ...
            <div className="grow">
              ...
              <p className="text-xs uppercase text-gray-500">October</p>
            </div>
          </div>
